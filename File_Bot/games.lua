...
if text == 'للاتازو' and database:get(bot_id..'Lock:Games'..msg.chat_id_) then
...
•━━━━━━━━━━━━━•ٴ
彡 .[𝘉𝘖𝘠𝘒𝘈 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/NiGGa_SoUrcE)➢
]]
...
if text == 'ورززانن' and Manager(msg) then   
if database:get(bot_id..'Lock:Games'..msg.chat_id_)  then
...
if text == 'ووززوةث' and Manager(msg) then  
